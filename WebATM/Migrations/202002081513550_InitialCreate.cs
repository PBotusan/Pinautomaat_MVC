namespace WebATM.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        {
            CreateTable(
                "dbo.Checking_Accounts",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        AccountNummer = c.String(nullable: false),
                        Voornaam = c.String(nullable: false, maxLength: 32),
                        Achternaam = c.String(nullable: false, maxLength: 32),
                        TelefoonNummer = c.String(nullable: false, maxLength: 32),
                ...
                c => new
                    {
                        ...
                        TelefoonNummer = c.String(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.Checking_Accounts");
        }
    }
}
